...
Увеличение хранимого значения, со значением по умолчание, если такое не найдено:

```swift
animalCount[key, default: 0] += 1
```

Поиск значения которое чаще всего встречается в массиве:
